...
class TestAll(unittest.TestCase):
    ...
    def test_valid_get_optimal_models(self):
        ...
        self.assertTrue(np.all(df1.iloc[:,-1] == self.splitters[1].n_splits))
        ...
        self.assertTrue(np.all(df2.iloc[:,-1] == self.splitters[1].n_splits))
        ...
        self.assertTrue(np.all(df3.iloc[:,-1] == self.splitters[1].n_splits))
        ...
        self.assertTrue(np.all(df4.iloc[:,-1] == self.splitters[1].n_splits))
