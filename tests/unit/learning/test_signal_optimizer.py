...
class TestAll(unittest.TestCase):
    ...
    def setUpClass(self):
        ...
        df_xcats.loc["CPI"] = ["2000-01-01", "2020-12-31", 1, 2, 0.95, 1]
        df_xcats.loc["GROWTH"] = ["2001-01-01", "2020-12-31", 1, 2, 0.9, 1]
        df_xcats.loc["RIR"] = ["2000-01-01", "2020-12-31", -0.1, 2, 0.8, 0.3]
    ...
    #             n_jobs=1,
    #             n_iter=1,
    #             inner_splitters=self.splitters[1],
    #         )
    #     except Exception as e:
    ...
    #     so5 = SignalOptimizer(
    #         X=self.X_train, y=self.y_train.to_frame()
    #     )
    ...
    #         self.assertIsInstance(prediction_date[1], pd.MultiIndex)
    #         self.assertIsInstance(prediction_date[2], np.ndarray)
