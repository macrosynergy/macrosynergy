...
from macrosynergy.visuals import plot_lagged_correlation
import matplotlib
from unittest.mock import patch


class TestLaggedCorr(unittest.TestCase):
    @classmethod
    def setUpClass(self):
    ...
    def test_plot_lagged_correlation(self):
        try:
            plot_lagged_correlation(self.df, xcats=["INFL", "XR"], cids=self.cids)
