...
class TestAll(unittest.TestCase):
    ...
    def test_update_tickers(self):
        ...
        self.assertTrue(
            np.all(filt_df["value"].to_numpy() == compare_df["value"].to_numpy())
        )
    ...
    def test_update_categories(self):
        ...
        dfd_2_rv_divide = make_relative_value(
            dfd,
            xcats=["GROWTH", "INFL"],
            cids=None,
            blacklist=None,
        ...
        dfd_3 = make_relative_value(
            dfd_copy,
            xcats=["XR", "GROWTH", "INFL"],
            cids=None,
            blacklist=None,
            basket=None,
            rel_meth="subtract",
    ...
    def test_update_df(self):
        ...
        dfd_update_rv = dfd_update[
            ((dfd_update["xcat"] == "GROWTHRV") & (dfd_update["cid"] == "AUD"))
        ]
