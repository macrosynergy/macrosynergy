...
class TestOAuth(unittest.TestCase):
    def test_init(self):
        oauth : dataquery.OAuth = dataquery.OAuth(client_id="test-id", client_secret="SECRET")
    ...
    def test_invalid_init_args(self): 
        ...
        with self.assertRaises(ValueError):
            dataquery.OAuth(client_id="test-id", client_secret="SECRET", dq_resource_id=None)        
