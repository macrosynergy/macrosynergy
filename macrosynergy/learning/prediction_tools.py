...
def adaptive_preds_to_signal(
    ...
    columns: List[str] = list(set([model + "_" + metric if hparam_grid[model] != {} else model for model in models.keys() for metric in metrics.keys()]))
...
if __name__ == "__main__":
    ...
    metrics = {"bac": make_scorer(regression_balanced_accuracy, greater_is_better=True),
    ...
    inner_splitter = PanelTimeSeriesSplit(
        n_split_method="rolling", n_splits = 4
    )
