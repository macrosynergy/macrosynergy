...
if __name__ == "__main__":
    ...
    df = pd.read_csv("./macrosynergy/panel/test.csv")
    fxblack = {'CHF': (Timestamp('2011-10-03 00:00:00'), Timestamp('2015-01-30 00:00:00')),
        ...
        'TRY_2': (Timestamp('2020-01-01 00:00:00'), Timestamp('2022-08-01 00:00:00'))}
