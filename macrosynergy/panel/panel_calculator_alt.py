...
def panel_calculator(df: pd.DataFrame, calcs: List[str] = None, cids: List[str] = None,
    ...
    # Todo: pivot on all old_xcats_used and assign df to xcat name
    # Todo: maybe later: ensure equal columns and indices of wide dataframes
    # Todo: use evaluate to create new df
    # Todo: collect all new dfs in standard format
