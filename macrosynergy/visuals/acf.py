...
def _statsmodels_plot_acf_wrapper(real_dates, values, ax, **kwargs):
    """
    Wrapper function for statsmodels plot_acf.
    """
    plot_acf_sm(x=values, ax=ax, **kwargs)


def _statsmodels_plot_pacf_wrapper(real_dates, values, ax, **kwargs):
    """
    Wrapper function for statsmodels plot_pacf.
    """
    plot_pacf_sm(x=values, ax=ax, **kwargs)
