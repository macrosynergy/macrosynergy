...
class DataQueryInterface(JPMaQSDownload):
    ...
    compatibility with the deprecated `macrosynergy.management.dq.DataQueryInterface` 
    class.
    """

    def __init__(self, *args, **kwargs):
        warnings.warn(
            "Functionality for DataQueryInterface has been moved to "
            "`macrosynergy.download.jpmaqs.JPMaQSDownload` - will be removed in v0.1.0",
            DeprecationWarning,
            stacklevel=2,
        )
