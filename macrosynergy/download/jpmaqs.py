...
class JPMaQSDownload(object):
    ...
    def array_construction(self, metrics: List[str], output_dict: dict,
    ...
    def download(self,
        ...
        if error_tickers:
            ...
            try:
                ...
                df = self.dataframe_wrapper(_dict=results_dict, no_metrics=no_metrics, original_metrics=metrics)
