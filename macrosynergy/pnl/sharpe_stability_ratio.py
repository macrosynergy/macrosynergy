...
def sharpe_stability_ratio(
    ...
    annualization_factor : int, default 261
        ...
        ratios. The macrosynergy package convention is 261.
    ...
    Bajo Traver, M., Rodríguez Domínguez, A. (2026). The Sharpe Stability
        Ratio: Temporal Consistency of Risk-Adjusted Performance.
